...
# adjust according to your acticve environment
...
"""
(2) Validation for coefficient of variation.
Here, we start with the same normal distribition, and sample 100,000 points for 
each varying cv value.  
What to expect if pick_indiv is working correctly:
  - as the CV increases, the distrubution should get wider. 
"""
#========================================================================#
# 			            Pick Individual
#========================================================================#
