...
function make_pop_df_long(pop_stand_out_all, sim_params )
...
function make_trait_mean_df_long(x_stand_out_all, sim_params )
    @unpack t_max, no_species, no_columns, no_param, num_time_steps,min_time_step_to_store  = sim_par    
    num_rep
    length(GEM_ver)
    ...
    return par_mean_df = vcat(x_out_spp_store...)

end

# =============================================================

function make_trait_var_df_long()
    ...
    return par_var_df = vcat(x_out_var_spp_store...)
end